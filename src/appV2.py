...
def predict():
    ...
    if client_data is None:
        return render_template('indexV2.html', prediction='Client ID not found', local_importances=None, global_importances=None)
    ...
    # Arrondir les valeurs d'importance à 3 décimales
    local_importances_df['Importance'] = local_importances_df['Importance'].round(3)
